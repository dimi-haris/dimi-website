...
export default function About(): React.ReactElement | null {
	return (
		// Main container
		<div className="w-screen flex flex-col pt-72 pb-52">
			{/* Title wrapper */}
			...
			{/* Content wrapper */}
			<div className="w-full max-w-[825px] self-center flex flex-col gap-5 pt-52">
				{/* Content */}
				<p className="text-[32px] text-heading">
				...
				{/* Content */}
				<p className="text-lg text-[#42718D] max-w-[550px]">
					Giving{" "}
