    ...
    <div className="w-screen flex flex-col items-center gap-10 sm:gap-20 pb-15">
      ...
      <div className="w-[85%] sm:w-[90%] flex flex-col gap-5">
        ...
        <div className="bg-white py-8">
          <div className=" px-4">
            <h2 className="text-3xl font-bold mb-8">Next Episode</h2>
                  ...
                  <div className="col-span-5 flex items-center gap-3">
                    ...
                    <button
                      className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition ${
                        episode.isPlaying ? "bg-[#E5AB4E]" : "bg-[#FFF] "
                      }`}
                      aria-label={episode.isPlaying ? "Pause" : "Play"}
                    >
                      {episode.isPlaying ? (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="relative flex-shrink-0">
                      <img
                       src={"/images/podcast-Episode.png"}
                        alt={episode.title}
                        width="64"
                        height="64"
